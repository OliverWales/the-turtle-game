...
GameState::GameState(GameDataRef data) : _data(data)
{
    ...
    if (!_p1TurtleTexture.loadFromFile("Turtle1.png"))
    {
        exit(EXIT_FAILURE);
    }
    if (!_p2TurtleTexture.loadFromFile("Turtle2.png"))
    {
        exit(EXIT_FAILURE);
    }

    _p1Turtle.setTexture(_p1TurtleTexture);
    _p1Turtle.setPosition(sf::Vector2f(150, 150));
    ...
    _p2Turtle.setPosition(sf::Vector2f(250, 150));
...
void GameState::draw()
{
    _data->window.clear(sf::Color(80, 120, 180));
